...
public class WinnerVerifier {
    ...
    private boolean isWinner(final GameTable gameTable, final char sign) {
        return isWinnerByRows(gameTable, sign) ||
                ...
                isWinnerMainDiagonel(gameTable, sign) ||
                isWinnerSecondDiagonel(gameTable, sign);
    ...
    private boolean isWinnerSecondDiagonel(final GameTable gameTable, final char sign) {
    ...
    private boolean isWinnerMainDiagonel(final GameTable gameTable, final char sign) {
